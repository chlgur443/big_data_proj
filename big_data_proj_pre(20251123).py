# -*- coding: utf-8 -*-
"""big_data_Proj_pre(20251108).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1DXs5cf8BKMvO9w_L_Ij0rzkGeqEcqQj3
...
ax.set(xlabel = '시간대', ylabel = '승객수', title = '행정동별 지하철 승객수 (' + town_label[0] + ', ' + town_label[1]+ ', ' + str(day_label[0]) + ')')
...
ax.set(xlabel = '시간대', ylabel = '승객수', title = str(month_label[0]) + ' 호선별 지하철 승객수')
